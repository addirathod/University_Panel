...
public final class allocate_005fresource_005ffinal_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 for(String s:items)
 {
     String user=(String)session.getAttribute("user");
      ...
      _jspx_th_sql_update_0.setVar("user_resource_map");
      ...
      try {
        ...
        if (_jspx_eval_sql_update_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          ...
          do {
            out.write("\n");
            out.write("            INSERT INTO user_resource_map (id,resource) values (\"");
 out.print(user); 
            out.write("\",\"");
 out.print(s); 
            out.write("\")\n");
